...
from .data import EvalWPoseDataset, EvalDataset
...
def recon(opt, use_rect=False, image_name=''):
    # load checkpoints
    ...
    # issue -> not correct directory, creates checkpoints folder inside pifuhd_api_example folder
...
def reconWrapper(args=None, use_rect=False, image_name=''):    
    return recon(args, use_rect, image_name)
